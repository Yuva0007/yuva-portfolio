  ...
  const contactItems = [
    {
      icon: Mail,
      label: "Email",
      value: "yuvaraj.m.7891@gmail.com",
      href: "mailto:yuvaraj.m.7891@gmail.com",
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 81227 75039",
      href: "#",
      onClick: (e: React.MouseEvent) => {
        e.preventDefault();
        const message = "Hello, I saw your portfolio - Yuvaraj";
        const url =
          "https://wa.me/918122775039?text=" + encodeURIComponent(message);
    ...
    },
    {
      ...
      label: "LinkedIn",
      value: "Yuvaraj M",
      href: "https://www.linkedin.com/in/yuvaraj-m-bb42ab354/",
    },
    {
      icon: Github,
      label: "GitHub",
      value: "Yuva0007",
      href: "https://github.com/Yuva0007",
    },
  ];
      ...
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-primary text-primary-foreground rounded-xl font-semibold text-sm hover:bg-primary/90 transition-all active:scale-95 shadow-lg shadow-primary/25"
            >
